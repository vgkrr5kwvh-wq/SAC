...
export default function UniversityManagementOverview({ data }: { data: UniversityManagementOverviewApiResult }) {
  ...
  return <div className="university-management-detail">
    ...
    <nav className="university-management-tabs" aria-label="University management sections"><span aria-current="page">Overview</span>{tabs.map(([tab, count]) => <span key={tab} aria-disabled="true"><b>{tab} ({count})</b><small>Coming soon</small></span>)}</nav>
